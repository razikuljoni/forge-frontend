    ...
    >
      <div className="relative overflow-hidden aspect-[3/4] bg-forge-gray">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5">
          <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-forge-orange mb-1">{role}</div>
          <div className="font-heading text-lg font-bold text-white uppercase">{name}</div>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-forge-orange">Expert Coaching Staff</span>
            </div>
          ...
          <p className="text-sm text-forge-silver max-w-md leading-relaxed">
            Every FORGE coach holds nationally recognized certifications and has a minimum of 5 years experience in strength & conditioning.
          </p>
        </div>

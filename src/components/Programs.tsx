            ...
            <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                    {tags.map((tag) => (
                        <span
                            key={tag}
                            className="text-[9px] font-semibold uppercase tracking-wider bg-white/5 text-forge-silver px-2.5 py-1"
                        >
                            {tag}
                        </span>
                    ))}
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/5">
                    ...
                    <Link
                        href="#book"
                        className="inline-flex items-center gap-1.5 text-forge-orange text-xs font-bold uppercase tracking-wider group-hover:gap-3 transition-all"
                    >
    ...
    const programs = [
        {
            title: 'Muscle Gain',
            description:
                'Progressive overload methodology. Compound movements + accessory isolation for maximum hypertrophy. 4-5 days/week split programming.',
            price: '$199',
        ...
        },
        {
            title: 'Fat Loss',
            description:
                'Metabolic conditioning + strategic cardio protocol. Torch body fat while preserving lean muscle. Calibrated nutrition guidance included.',
            price: '$179',
        ...
        },
        {
            title: 'Total Fitness',
            description:
                'Balanced programming for overall health and vitality. Strength, mobility, endurance, and flexibility in one comprehensive package.',
            price: '$149',
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
                    ...
                    <p className="text-sm text-forge-silver max-w-md leading-relaxed">
                        Every program is engineered for results. No fluff, no gimmicks—just
                        science-backed training methodologies delivered by world-class coaches.
                    </p>
                </div>
                ...
                <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        ...
                        { icon: 'lucide:users', label: 'Max 8:1', sub: 'Coach Ratio' },
                        {
                            ...
                            label: 'InBody Scan',
                            sub: 'Monthly Assessment',
                        },
                        { icon: 'lucide:salad', label: 'Nutrition', sub: 'Plan Included' },
                    ].map((item, idx) => (
                        <div
                            key={idx}
                            className="bg-forge-gray p-4 flex items-center gap-3 border border-white/5"
                        >

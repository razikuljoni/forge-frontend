        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-forge-orange">Start Today</span>
              </div>
              ...
              <p className="text-sm md:text-base text-forge-silver max-w-lg leading-relaxed">
                No contracts. No commitments. Just show up and give us everything you've got for one hour. If FORGE isn't the hardest, most rewarding workout of your life—we'll eat our protein powder.
              </p>
            </div>
              ...
              {[
                ...
                <div key={idx} className="flex items-center gap-3">
                  <div className="w-4 h-4 bg-forge-orange flex items-center justify-center flex-shrink-0">
                    <Icon icon="lucide:check" className="text-forge-black" width="10" />
                  </div>
            ...
            <div className="flex items-center gap-4 pt-8 border-t border-white/5">
              ...
              <div>
                <div className="flex items-center gap-1">
                  {[1, 2, 3, 4, 5].map(i => (
                    <Icon key={i} icon="lucide:star" className="text-orange-400" width="12" />
                  ))}
                  <span className="text-xs font-bold text-white ml-1">4.9</span>
                </div>
                <div className="text-[10px] text-forge-silverDark">Based on 500+ reviews</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="bg-forge-gray border border-white/10 p-6 md:p-10 rounded-sm relative z-10">
              <div className="mb-8">
                <h3 className="font-heading text-2xl font-bold uppercase text-white mb-2">Book Your Free Trial</h3>
                <p className="text-xs text-forge-silver">Fill out the form below and we'll get you started within 24 hours.</p>
              </div>

              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="text-[10px] font-bold uppercase tracking-wider text-forge-silver">First Name *</label>
                    <input 
                      required
                      type="text" 
                      placeholder="John"
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] font-bold uppercase tracking-wider text-forge-silver">Last Name *</label>
                    <input 
                      required
                      type="text" 
                      placeholder="Doe"
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold uppercase tracking-wider text-forge-silver">Email *</label>
                  <input 
                    required
                    type="email" 
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold uppercase tracking-wider text-forge-silver">Phone *</label>
                  <input 
                    required
                    type="tel" 
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold uppercase tracking-wider text-forge-silver">Your Goal *</label>
                  <div className="relative">
                    <select className="w-full px-4 py-3 bg-white/5 border border-white/10 text-white text-sm focus:border-forge-orange outline-none appearance-none transition-all">
                      <option className="bg-forge-gray">Select your primary goal</option>
                      <option className="bg-forge-gray">Muscle Gain</option>
                      <option className="bg-forge-gray">Fat Loss</option>
                      <option className="bg-forge-gray">Overall Health</option>
                      <option className="bg-forge-gray">Athletic Performance</option>
                    </select>
                    <Icon icon="lucide:chevron-down" className="absolute right-4 top-1/2 -translate-y-1/2 text-forge-silver pointer-events-none" width="16" />
                  </div>
                </div>

                <div className="space-y-1">
                  <label className="text-[10px] font-bold uppercase tracking-wider text-forge-silver">Experience Level</label>
                  <div className="flex gap-2">
                    {['Beginner', 'Intermediate', 'Advanced'].map((level) => (
                      <label key={level} className="flex-1 cursor-pointer">
                        <input type="radio" name="level" value={level.toLowerCase()} className="sr-only peer" defaultChecked={level === 'Beginner'} />

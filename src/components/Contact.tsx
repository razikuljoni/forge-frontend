...
export default function Contact() {
  return (
    <section id="contact" className="relative py-16 md:py-20 bg-forge-dark border-t border-white/5">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-forge-silver">Location</span>
            </div>
            <p className="text-sm text-white font-semibold mb-1">FORGE Fitness Studio</p>
            <p className="text-xs text-forge-silver leading-relaxed">
              234 Iron District Blvd<br />
              Suite 500<br />
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-forge-silver">Hours</span>
            </div>
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-forge-silver">Contact</span>
            </div>
            <div className="space-y-1.5">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-forge-silver">Follow Us</span>
            </div>

  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 pt-32 pb-20 md:pt-40 md:pb-28 w-full">
        <div className="grid lg:grid-cols-12 gap-6 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            >
              Where discipline meets community. FORGE is not just a gym—it's a brotherhood of iron.
              Professional coaching, proven results, and an environment designed to push you beyond what you thought possible.
            </motion.p>
            ...
            >
              {stats.map((stat, idx) => (
                <React.Fragment key={stat.label}>
                  <div>
                    <div className="stat-number font-heading text-3xl md:text-4xl font-bold">{stat.value}</div>
                    <div className="text-[10px] uppercase tracking-[0.2em] text-forge-silverDark mt-1">{stat.label}</div>
                  </div>
                  {idx !== stats.length - 1 && <div className="w-px bg-white/10" />}
                </React.Fragment>
              ))}
            </motion.div>
          ...
          >
            <div className="relative">
              <div className="relative overflow-hidden rounded-sm">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                  <div className="flex items-end justify-between">
                    <div>
                      <div className="text-[10px] font-bold uppercase tracking-[0.3em] text-forge-orange mb-1">Head Coach</div>
                      <div className="font-heading text-xl font-bold text-white uppercase">Marcus Chen</div>
                      <div className="text-xs text-forge-silver mt-0.5">NSCA-CSCS • 12 Years Experience</div>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <div className="w-2 h-2 rounded-full bg-forge-orange animate-pulse" />
                      <span className="text-[10px] uppercase tracking-wider text-forge-orange font-semibold">Available</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-2 mt-2">
                {coaches.map((coach) => (
                  <div key={coach.name} className="relative flex-1 overflow-hidden rounded-sm h-24 group">
                    <img 
                      src={coach.img} 
                      alt={coach.name} 
                    ...
                    <div className="absolute bottom-1.5 left-2 text-[9px] font-bold uppercase tracking-wider text-white">{coach.name}</div>
                  </div>
                ))}
                <Link 
                  href="#coaches" 
                ...
                >
                  <div className="text-center">
                    <div className="font-heading text-lg font-bold text-white group-hover:text-forge-orange transition-colors">12+</div>
                    <div className="text-[8px] uppercase tracking-wider text-forge-silver">View All</div>
                  </div>
                </Link>
              </div>
            </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 animate-bounce">
        <span className="text-[9px] uppercase tracking-[0.3em] text-forge-silverDark">Scroll</span>

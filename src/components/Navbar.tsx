        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link href="#" className="flex items-center gap-2 group">
            <div className="w-8 h-8 bg-forge-orange flex items-center justify-center">
              <span className="font-heading font-bold text-forge-black text-lg leading-none">F</span>
            </div>
            <span className="font-heading font-bold text-xl tracking-wider text-white uppercase">Forge</span>
          </Link>
